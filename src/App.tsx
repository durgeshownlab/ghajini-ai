...
function App() {
  ...
  const [messages, setMessages] = useState<Message[]>([{text: "Hello! I’m Ghajini AI, your AI assistant with a short-term memory loss for your privacy. How can i help you today?", isUser: false}]); // Store messages
